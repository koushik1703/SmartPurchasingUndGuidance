...
class Shortest_Path:
    ...
    def Main(self):
        ...
        for Index, Coordinates in enumerate(self.tsp_path[:]):
            ...
            #Give values to the PDDL generator
            ...
            #Generate the response from PDDL 
            self.PDDL_Generator.Generate_PDDL_Script()
            
            #Get the response from PDDL Generaote
            Response = self.PDDL_Generator.Get_Response()
            
            #Check if the PDDL script has worked properly, if not print a message and exit
            if(Response == "All paths blocked"):
                ...
                while(P1_Init != P2_Des):
                    ...
                    #Read the plan generated by the PDDL and accordingly pass the commands to SOUG_Run
